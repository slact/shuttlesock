...
submod:subscribe("lua_testmod:blep", function(self, code)
  assert(not self.got_blep)
  assert(code == 0)
  self.got_blep = true
end)
submod:subscribe("lua_testmod:foo", function(self, code)
...
submod:subscribe("lua_testmod:bar", function(self, code, data)
  assert(self.got_blep)
  assert(self.got_foo)
...
submod:subscribe("lua_testmod:baz", function(self, code, data)
  assert(self.got_blep)
  assert(self.got_foo)
  assert(self.got_foo2)
  assert(self.got_bar)
...
submod:subscribe("lua_testmod:floatey", function(self, code, data)
  assert(self.got_blep)
  assert(self.got_foo)
  assert(self.got_foo2)
  assert(self.got_bar)
