...
assert_match_path("/foo", "foo")
assert_match_path("/foo", "**/**/**/foo/**")
assert_match_path("/foo", "(bar|baz|foo)")
assert_not_match_path("/foo", "(bar|baz)")
assert_match_path("/foo/bar/baz", "/foo/(what|is|bar)/*")
assert_not_match_path("/foo/nomatch/baz", "/foo/(what|is|bar)/*")
assert_not_match_path("/foo", "*/foo")
