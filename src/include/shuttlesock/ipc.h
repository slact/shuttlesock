...
#define SHUTTLESOCK_IPC_CMD_SET_LOG_FD            5
#define SHUTTLESOCK_IPC_CMD_OPEN_LISTENER_SOCKETS 6
#define SHUTTLESOCK_IPC_CMD_OPEN_LISTENER_SOCKETS_RESPONSE 7
#define SHUTTLESOCK_IPC_CMD_ALL_WORKERS_STARTED 8
#define SHUTTLESOCK_IPC_CMD_WORKER_STARTED 9
#define SHUTTLESOCK_IPC_CMD_WORKER_STOPPED 10
#define SHUTTLESOCK_IPC_CMD_MANAGER_PROXY_MESSAGE 11
#define SHUTTLESOCK_IPC_CMD_RECEIVE_PROXIED_MESSAGE 12

#define SHUTTLESOCK_IPC_CMD_LUA_MESSAGE 13
#define SHUTTLESOCK_IPC_CMD_LUA_MESSAGE_RESPONSE 14
#define SHUTTLESOCK_IPC_CMD_LUA_MANAGER_PROXY_MESSAGE 15
#define SHUTTLESOCK_IPC_CMD_LUA_MANAGER_RECEIVE_PROXIED_MESSAGE 16
