...
function(target_require_package target scope name)
  set(oneValueArgs OPTIONAL INCLUDE_PATH_VAR LINK_LIB_VAR FAIL_MESSAGE_EXTRA)
  ...
  if(DEFINED ${LIBNAME}_FOUND AND NOT "${REQUIRE_PACKAGE_QUIET}")
    if(NOT "${${LIBNAME}_FOUND}")
      set(_is_found "not ")
    endif()
    message(STATUS "Assume ${REQUIRE_PACKAGE_DISPLAY_NAME} is ${_is_found}installed")
  else()
    ...
    elseif(NOT ${LIBNAME}_FOUND AND NOT REQUIRE_PACKAGE_QUIET)
      if(NOT REQUIRE_PACKAGE_FAIL_MESSAGE_EXTRA STREQUAL "")
        message(STATUS "Check if ${REQUIRE_PACKAGE_DISPLAY_NAME} is installed - no. ${REQUIRE_PACKAGE_FAIL_MESSAGE_EXTRA}")
      else()
