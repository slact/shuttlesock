...
function(add_core_module MODULE_NAME)
  ...
  foreach(CORE_SRC IN LISTS CORE_MODULE_SOURCES)
    list(APPEND CORE_PATHED_SOURCES "src/modules/${MODULE_NAME}/${CORE_SRC}")
  endforeach()
  ...
  foreach(CORE_HEADER IN LISTS CORE_MODULE_HEADERS)
    if(CORE_HEADER STREQUAL "PRIVATE")
      ...
      set(header_file "src/modules/${MODULE_NAME}/${CORE_HEADER}")
      list(APPEND pathed_core_header_files ${header_file})
      set(dst_header_file "src/include/shuttlesock/modules/${MODULE_NAME}/${CORE_HEADER}")
      if(NOT EXISTS "${header_file}")
        message(FATAL_ERROR "module ${MODULE_NAME} has no header file ${header_file}")
      endif()
      list(APPEND SHUTTLESOCK_CORE_MODULE_HEADERS "${MODULE_NAME}/${CORE_HEADER}")
      ...
      if(NOT private_header)
        list(APPEND SHUTTLESOCK_CORE_MODULE_INCLUDE_HEADERS "${MODULE_NAME}/${CORE_HEADER}")
  ...
  if(LUA_MODULES_LENGTH GREATER 0)
    ...
    foreach(index RANGE 0 ${rangemax} 2)
      ...
      pack_lua_module("${lmname}" "src/modules/${MODULE_NAME}/${lmfile}")
    endforeach()
  endif()
  ...
  if(LUA_SOURCES_LENGTH GREATER 0)
    ...
    foreach(index RANGE 0 ${rangemax} 2)
      ...
      pack_lua_script("${lsname}" "src/modules/${MODULE_NAME}/${lsfile}")
    endforeach()
  endif()
