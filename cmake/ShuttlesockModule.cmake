...
function(add_static_module MODULE_NAME)
  ...
  foreach(STATIC_HEADER IN LISTS STATIC_HEADERS)
    if(STATIC_HEADER STREQUAL "PRIVATE")
      ...
      if(NOT private_header)
        list(APPEND SHUTTLESOCK_STATIC_MODULE_INCLUDE_HEADERS "${STATIC_HEADER}")
        set(SHUTTLESOCK_STATIC_MODULE_INCLUDE_HEADERS "${SHUTTLESOCK_STATIC_MODULE_INCLUDE_HEADERS}" CACHE INTERNAL "Static module headers" FORCE)
      endif()
  ...
  if(LUA_MODULES_LENGTH GREATER 0)
    ...
    foreach(index RANGE 0 ${rangemax} 2)
      ...
      message("${lmname} src/modules/${lmfile}")
...
function(finish_adding_static_modules ALL_CORE_MODULES_HEADER)
  ...
  endforeach()
  foreach(header IN LISTS SHUTTLESOCK_STATIC_MODULE_INCLUDE_HEADERS)
