...
macro(add_lua_script_internal module_name source_file)
...
function(add_lua_module module_name source_file)
  add_lua_script_internal(${module_name} ${source_file} MODULE CHECK)
endfunction()
function(add_lua_bundled_module module_name source_file)
  add_lua_script_internal(${module_name} ${source_file} MODULE BUNDLED)
endfunction()
function(add_lua_script script_name source_file)
  add_lua_script_internal(${script_name} ${source_file} CHECK)
endfunction()
